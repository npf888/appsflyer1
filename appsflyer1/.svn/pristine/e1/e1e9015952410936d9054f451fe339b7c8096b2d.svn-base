...
public class _log_0slotwinner__jsp extends com.caucho.jsp.JavaPage{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("texas/log/log_slotwinner.jsp"), -535574354070430518L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

...
<div class="row-fluid">
	<div class="table-responsive" style="overflow-x:scroll">
		<form class="form-inline" action="log.do?method=online" method="post" id="searchForm">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover dataTables-example">
			...
			<tbody style="position:relative">		
			 ...
			 <tr>
			    <td>${MapData.time_dian}</td>
			    <td>${MapData.value_role}</td>
			    <td><fmt:formatNumber type="number" value="${MapData.valueData*0.1*10/100}" maxFractionDigits="2"/></td>
			 </tr>
			  </c:forEach>

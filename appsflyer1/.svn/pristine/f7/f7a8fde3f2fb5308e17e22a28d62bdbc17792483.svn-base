...
public class _weekcard_0list__jsp extends com.caucho.jsp.JavaPage{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("texas/game/weekcard_list.jsp"), -3482585595443758303L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

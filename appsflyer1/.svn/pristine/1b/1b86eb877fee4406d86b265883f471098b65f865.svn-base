...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/js/Clockpicker/bootstrap-clockpicker.min.css">
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/ichart/ichart.1.2.1.min.js"></script>
...
<div class="">
	<div class="row-fluid" >
		<form class="form-inline" action="${path}/log.do?method=ichartOnline" method="post" id="searchForm">
			时间:&nbsp;&nbsp;&nbsp;&nbsp; 
			...
			<select name="country" style="width:100px">
				...
				<c:forEach var="country" items="${countryList}">
					<option value="${country.country }" <c:if test="${cou==country.country }">selected="selected"</c:if> >${country.langDesc }</option>
				</c:forEach>
			</select>
			&nbsp;&nbsp;&nbsp;&nbsp;

...
public class _log_0online__jsp extends com.caucho.jsp.JavaPage{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      while (_jsp_iter_1.hasNext()) {
        ...
        _jsp_FormatNumberTag_0.setValue(_caucho_expr_4.evalObject(pageContext));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("texas/log/log_online.jsp"), 1748959908880656375L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  private final static com.caucho.el.Expr _caucho_expr_2 =
    new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("MapData"), new com.caucho.el.StringLiteral("time_dian")), "MapData.time_dian");
  private final static com.caucho.el.Expr _caucho_expr_3 =
    new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("MapData"), new com.caucho.el.StringLiteral("value_role")), "MapData.value_role");
  private final static com.caucho.el.Expr _caucho_expr_4 =
    new com.caucho.el.BinaryExpr(4, new com.caucho.el.BinaryExpr(3, new com.caucho.el.BinaryExpr(3, new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("MapData"), new com.caucho.el.StringLiteral("valueData")), "MapData.valueData"), new com.caucho.el.DoubleLiteral(0.1)), new com.caucho.el.LongLiteral(10L)), new com.caucho.el.LongLiteral(100L));

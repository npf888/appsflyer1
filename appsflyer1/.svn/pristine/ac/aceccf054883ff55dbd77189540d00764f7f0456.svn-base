...
public class _toindex__jsp extends com.caucho.jsp.JavaPage{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("common/toIndex.jsp"), 8035618873459622277L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }

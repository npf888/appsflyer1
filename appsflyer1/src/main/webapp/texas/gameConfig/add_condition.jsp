...
<form class="form-horizontal" action="activity.do?method=doAddCondition" method="post" id="form" enctype="multipart/form-data">
	 
	  <h2 style="margin-left:100px;padding-bottom:30px">添加触发条件或奖励</h2>
	  <div class="control-group">
		<label class="control-label" for="form-field-accout">ID:</label>
		<div class="controls">
		  <input type="text" name="id" class="validation" requiry="true">
		</div>
	  </div>
...
{ 
	...
	bootbox.alert("添加成功",
	function() {
		nav('activity.do?method=toAddCondition','Condition');
		});
}

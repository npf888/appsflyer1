...
public class _log_0slotmaxspin__jsp extends com.caucho.jsp.JavaPage{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      while (_jsp_iter_1.hasNext()) {
        ...
        _jsp_FormatNumberTag_0.setValue(_caucho_expr_7.evalObject(pageContext));
        _jsp_FormatNumberTag_0.doEndTag();
        out.write(_jsp_string6, 0, _jsp_string6.length);
        if (_jsp_FormatNumberTag_0 == null) {
          _jsp_FormatNumberTag_0 = new org.apache.taglibs.standard.tag.rt.fmt.FormatNumberTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("texas/log/log_slotMaxSpin.jsp"), 8795249685157104763L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  private final static com.caucho.el.Expr _caucho_expr_3 =
    new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("MapData"), new com.caucho.el.StringLiteral("win8"));
  private final static com.caucho.el.Expr _caucho_expr_4 =
    new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("MapData"), new com.caucho.el.StringLiteral("win11")), "MapData.win11");
  private final static com.caucho.el.Expr _caucho_expr_5 =
    new com.caucho.el.BinaryExpr(4, new com.caucho.el.BinaryExpr(3, new com.caucho.el.BinaryExpr(3, new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("MapData"), new com.caucho.el.StringLiteral("win9")), new com.caucho.el.DoubleLiteral(0.1)), new com.caucho.el.LongLiteral(10L)), new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("MapData"), new com.caucho.el.StringLiteral("win8")));
  private final static com.caucho.el.Expr _caucho_expr_6 =
    new com.caucho.el.BinaryExpr(4, new com.caucho.el.BinaryExpr(3, new com.caucho.el.BinaryExpr(3, new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("MapData"), new com.caucho.el.StringLiteral("win10")), "MapData.win10"), new com.caucho.el.DoubleLiteral(0.1)), new com.caucho.el.LongLiteral(10L)), new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("MapData"), new com.caucho.el.StringLiteral("win8")), "MapData.win8"));
  private final static com.caucho.el.Expr _caucho_expr_7 =
    new com.caucho.el.BinaryExpr(4, new com.caucho.el.BinaryExpr(3, new com.caucho.el.BinaryExpr(3, new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("MapData"), new com.caucho.el.StringLiteral("win12")), "MapData.win12"), new com.caucho.el.DoubleLiteral(0.1)), new com.caucho.el.LongLiteral(10L)), new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("MapData"), new com.caucho.el.StringLiteral("win8")), "MapData.win8"));
  private final static com.caucho.el.Expr _caucho_expr_8 =
    new com.caucho.el.BinaryExpr(4, new com.caucho.el.BinaryExpr(3, new com.caucho.el.BinaryExpr(3, new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("MapData"), new com.caucho.el.StringLiteral("win11")), "MapData.win11"), new com.caucho.el.DoubleLiteral(0.1)), new com.caucho.el.LongLiteral(10L)), new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("MapData"), new com.caucho.el.StringLiteral("win12")), "MapData.win12"));

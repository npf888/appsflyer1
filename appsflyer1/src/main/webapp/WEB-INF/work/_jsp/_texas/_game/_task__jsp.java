...
public class _task__jsp extends com.caucho.jsp.JavaPage{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("texas/game/task.jsp"), -1455968446157832074L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
  ...
  private final static com.caucho.el.Expr _caucho_expr_6 =
    new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("user"), new com.caucho.el.StringLiteral("dailytaskpack")), "user.dailytaskpack");
  private final static com.caucho.el.Expr _caucho_expr_7 =
    new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("user"), new com.caucho.el.StringLiteral("taskpack")), "user.taskpack");

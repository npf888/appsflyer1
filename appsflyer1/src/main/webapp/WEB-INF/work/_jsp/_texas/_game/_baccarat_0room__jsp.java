...
public class _baccarat_0room__jsp extends com.caucho.jsp.JavaPage{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("texas/game/baccarat_room.jsp"), 5290936591341500729L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
  ...
  private final static com.caucho.el.Expr _caucho_expr_3 =
    new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("one"), new com.caucho.el.StringLiteral("roomid")), "one.roomid");
  ...
  private final static com.caucho.el.Expr _caucho_expr_5 =
    new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("one"), new com.caucho.el.StringLiteral("stock")), "one.stock");
  private final static com.caucho.el.Expr _caucho_expr_6 =
    new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("one"), new com.caucho.el.StringLiteral("jackpot")), "one.jackpot");
  private final static com.caucho.el.Expr _caucho_expr_7 =
    new com.caucho.el.EqExpr(6, new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("one"), new com.caucho.el.StringLiteral("closed")), "one.closed"), new com.caucho.el.LongLiteral(0L));
  private final static com.caucho.el.Expr _caucho_expr_8 =
    new com.caucho.el.EqExpr(6, new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("one"), new com.caucho.el.StringLiteral("closed")), "one.closed"), new com.caucho.el.LongLiteral(1L));
  private final static com.caucho.el.Expr _caucho_expr_9 =
    new com.caucho.el.PathExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("one"), new com.caucho.el.StringLiteral("update_time")), "one.update_time");
  ...
  static {
    ...
    _jsp_string13 = " </td>\r\n	                 <td>".toCharArray();
    _jsp_string5 = "</td>\r\n					<td>".toCharArray();
    _jsp_string10 = "\u5173\u95ed&nbsp;&nbsp;<button class=\"\" onclick=\"changeStatus('".toCharArray();
    _jsp_string17 = "\" class=\"edit-button\"> Edit </button></td>\r\n				</tr>\r\n				\r\n			  ".toCharArray();
    _jsp_string9 = "\r\n					".toCharArray();
    _jsp_string3 = "\r\n					\r\n				<tr id=\"tr_".toCharArray();
    _jsp_string15 = "\" data-toggle=\"modal\" data-target=\"#myModal\" stock=\"".toCharArray();
    ...
    _jsp_string12 = "</td>\r\n\r\n					\r\n	                 <td>".toCharArray();
    _jsp_string7 = "\u5f00\u542f&nbsp;&nbsp;<button class=\"\" onclick=\"changeStatus('".toCharArray();
    _jsp_string16 = "\" jackpot=\"".toCharArray();
    _jsp_string8 = "',1)\">\u5173\u95ed</button>".toCharArray();
    _jsp_string6 = "</td>\r\n					<td>\r\n					".toCharArray();
    ...
    _jsp_string4 = "\">\r\n					\r\n					<td>".toCharArray();
    _jsp_string11 = "',0)\">\u5f00\u542f</button>".toCharArray();
    _jsp_string14 = "</td>\r\n					 <td><button id=\"".toCharArray();

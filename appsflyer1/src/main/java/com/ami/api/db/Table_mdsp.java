...
@Component
public class Table_mdsp
{
    
    @Autowired
    private DBManagerService_mdsp mdsp_db;
        ...
        throws APIException, APIException, APIException
    {
        ...
        return this.mdsp_db.update(sql.toString(), prams);
        ...
        throws APIException, APIException, APIException
    {
        ...
        return this.mdsp_db.update(sql);
        ...
        throws APIException
    {
        ...
        this.mdsp_db.update(sql, new Object[]
        {id});
    }
        ...
        throws APIException
    {
        ...
        return this.mdsp_db.load(sql.toString());
        ...
        throws APIException
    {
        ...
        list_map = this.mdsp_db.query(sql);

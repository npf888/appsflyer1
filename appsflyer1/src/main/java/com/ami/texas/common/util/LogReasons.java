package com.ami.texas.common.util;
...
;
 ...
 ;
	...
	public enum GoldLogReason implements ILogReason , IndexedEnum
	{
		...
		@ReasonDesc("老虎机小游戏获得121")
		SLOT_SCATTER121(6082,"121老虎机小游戏{0},下注{1}"),
		
		@ReasonDesc("老虎机小游戏获得122")
		SLOT_SCATTER122(6083,"122老虎机小游戏{0},下注{1}"),
		@ReasonDesc("老虎机小游戏获得123")
		SLOT_SCATTER123(6084,"123老虎机小游戏{0},下注{1}"),
		@ReasonDesc("老虎机小游戏获得124")
		SLOT_SCATTER124(6085,"124老虎机小游戏{0},下注{1}"),
		@ReasonDesc("老虎机小游戏获得125")
		SLOT_SCATTER125(6086,"125老虎机小游戏{0},下注{1}"),
		@ReasonDesc("老虎机小游戏获得126")
		SLOT_SCATTER126(6087,"126老虎机小游戏{0},下注{1}"),
		@ReasonDesc("老虎机小游戏获得127")
		SLOT_SCATTER127(6088,"127老虎机小游戏{0},下注{1}"),
		@ReasonDesc("老虎机小游戏获得128")
		SLOT_SCATTER128(6089,"128老虎机小游戏{0},下注{1}"),
